...
SECRET_KEY = 'django-insecure-x6f_qgmq@4-8qvwx&zyk4bwcdryh0!@eht&j=q*49=mk9=sei@'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["inventaire.local"]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'inventaire_local',
        'USER': 'inventaire_local',
        'PASSWORD':'()Db0bc47_dkM_Xy',
        'HOST': 'localhost',
        'PORT': '3306'
    }
}
